...
router.get("/api/athletes/team/:OwnerId", function(req, res) {
  db.Athlete.findAll({
...
// route to return all athletes owned by one owner
router.get("/api/athletes/team/active/:OwnerId", function(req, res) {
  db.Athlete.findAll({
...
router.put("/api/athletes/owner/:id", function(req, res) {
...
// PUT route for updating athletess. We can access the updated athlete in req.body
router.put("/api/athletes/active/:id", function(req, res) {
  // Update takes in an object describing the properties we want to update, and
  // we use where to describe which objects we want to update
  console.log(req.body);
  db.Athlete.update({
...
// PUT route for updating athletess. We can access the updated athlete in req.body
router.put("/api/athletes/injured/:id", function(req, res) {
  // Update takes in an object describing the properties we want to update, and
  // we use where to describe which objects we want to update
  console.log(req.body);
  db.Athlete.update({
